...
public class Server extends Thread {
    ...
    public double deposit(int i, double amount) {
        ...
        curBalance = account[i].getBalance();   /* Get the updated accoung balance before releasing the semaphore */

        accSem.release(); /* Release the semaphore */
    ...
    public double withdraw(int i, double amount) {
        ...
        curBalance = account[i].getBalance();    /* Get the updated account balance before releasing semaphore */
    ...
    public void run() {
        ...
        if (serverThreadId.equals("ServerThread1")) {
            System.out.println("\n Terminating server thread 1 - " + " Running time "
                    + (serverEndTime - serverStartTime) + " milliseconds");
        } else {
            System.out.println("\n Terminating server thread 2 - " + " Running time "
                    + (serverEndTime - serverStartTime) + " milliseconds");
        }
